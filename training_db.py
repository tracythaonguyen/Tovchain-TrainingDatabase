...
class TrainingMongoDB:
    ...
    def get_all_restaurants_somefield(self, fields):
        return self.restaurants_col.find({}, fields)

    def get_all_restaurants_filter(self, filters):
        return self.restaurants_col.find(filters)

    def get_all_restaurants_field(self, filters, fields):
        return self.restaurants_col.find(filters, fields)
    ...
    def delete_many_restaurants(self, borough):
